...
if SERVER then
	...
	function GM:SetScore( ply, hole, score )
		...
		if !ply.Score then ply.Score = {} end
	...
	net.Receive( "RequestPars", function( len, ply )
		SendPars( ply )
	end )
	...
	net.Receive( "NetworkPars", function( length, client )
	...
	net.Receive( "NetworkScores", function( length, client )
