...
function DrawVideoInfo( w, h, scale )
	...
	-- Volume
	draw.TheaterText( TRA('Volume'):upper(), "VideoInfoSmall", w - 72, 120, Color(255,255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
	...
	if NumVoteSkips > 0 then
		draw.TheaterText( TRA('Voteskips'):upper(), "VideoInfoSmall", w - 72, 230, Color(255,255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
