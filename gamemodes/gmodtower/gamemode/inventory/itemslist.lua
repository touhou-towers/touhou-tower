...
/*RegisterItem("basketwood",{
	Name = "Wooden Basket",
	Description = "A wooden basket. Useful to store fruits in.",
	Model = "models/props_swamp/crate_ref.mdl",
	UniqueInventory = false,
	DrawModel = true,
	StoreId = 1,
	StorePrice = 75,
...
RegisterItem("tcrack",{
	Name = "Time Card Rack",
	Description = "Keep track of who shows up late every day.",
	Model = "models/props_spytech/time_card_rack.mdl",
	UniqueInventory = false,
	DrawModel = true,
	StoreId = 1,
	StorePrice = 175,
...
RegisterItem("svase",{
	Name = "Skull Vase",
	Description = "A special vase found in a secret castle in Narnia.",
