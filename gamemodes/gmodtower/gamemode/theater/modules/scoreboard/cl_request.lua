...
function HISTORY:Init()
	...
	self.Title = Label( TRA'Request_History', self )
	...
	ClearButton:SetText( TRA'Request_Clear' )
...
function VIDEO:Init()
	...
	self.RequestVideo:SetTooltip( TRA'Request_Video' )
	...
	self.DeleteVideo:SetTooltip( TRA'Request_DeleteTooltip' )
...
function VIDEO:SetVideo( vid )
	...
	self.Requests:SetText( TRA('Request_PlayCount', self.Video.count) )
