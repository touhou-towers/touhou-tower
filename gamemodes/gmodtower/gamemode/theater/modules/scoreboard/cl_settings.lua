...
function SETTINGS:Init()
	...
	self.Title = Label( TRA'Settings_Title', self )
	self.Title:SetFont( "ScoreboardTitleSmall" )
	self.Title:SetColor( Color( 255, 255, 255 ) )

	self.Help = Label( TRA'Settings_ClickActivate', self )
...
function SETTINGS:Create()
	...
	-- Hide Players
	local HidePlayers = self:NewSetting( "TheaterCheckBoxLabel", TRA'Settings_HidePlayersLabel', "cinema_hideplayers" )
	HidePlayers:SetTooltip( TRA'Settings_HidePlayersTooltip' )
