...
function EFFECT:Init( data )
	...
	local effecttype = data:GetAttachment()
	...
	local emitter = ParticleEmitter( PlyPos, false )
	
	local particle = emitter:Add( "effects/select_ring", PlyPos )
		if (particle) then
		
			particle:SetVelocity( Vel * -1 )
