...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
	...
	local material = "gmod_tower/virus/icons/" .. self.ClassName
	local textureid = surface.GetTextureID( material )

	draw.RoundedBox( 6, x, y, wide, tall, Color( 45, 63, 90, 100 ) )

	local sinAdjust = math.sin( CurTime() * 4 ) * 4

	surface.SetTexture( textureid )
	surface.SetDrawColor( 255, 255, 255, 255 )
	surface.DrawTexturedRect( x - 7, y + sinAdjust, 256, 256 )
