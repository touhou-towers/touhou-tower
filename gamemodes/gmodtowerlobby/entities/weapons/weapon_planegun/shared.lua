...
function SWEP:PrimaryAttack()
	...
	local Plane = self.Owner.plane

	if Plane then
		if Plane.Shooting != true then
			Plane.Shooting = true
		end

		--timer.Create( tostring(self.Owner:EntIndex()) .. "planesoundstop", 0.11, 1, StopSound, self.Owner )


	end

	self:ShootBullet( 50, 2, 0.04 )
