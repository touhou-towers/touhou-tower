...
//Models
SWEP.ViewModel				= Model("models/weapons/v_vir_snp.mdl")
SWEP.WorldModel				= Model("models/weapons/w_pvp_as50.mdl")
...
//Sounds
SWEP.Primary.Sound			= Sound("GModTower/virus/weapons/Sniper/shoot.wav")
