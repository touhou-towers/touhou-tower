...
function PANEL:PerformLayout()
	...
	SetCenteredPosition(self.ClassTxt, (x + (w * .52)), (y + (self.ClassTxt:GetTall() * num)));
	SetCenteredPosition(self.ScoreTxt, (x + (w * .642)), (y + (self.ScoreTxt:GetTall() * num)));
	SetCenteredPosition(self.DeathTxt, (x + (w * .742)), (y + (self.DeathTxt:GetTall() * num)));
	SetCenteredPosition(self.PingTxt, (x + (w * .842)), (y + (self.PingTxt:GetTall() * num)));
	SetCenteredPosition(self.RankTxt, (x + (w * .942)), (y + (self.RankTxt:GetTall() * num)));
