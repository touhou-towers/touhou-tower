...
function EFFECT:Render()
	...
	render.DrawQuadEasy( Pos, self.Norm, self.Size, self.Size, Color( 0, math.random( 100, 128 ), math.random( 240, 255 ), self.Alpha ) )
	render.DrawQuadEasy( Pos, self.Norm, self.Size / 2, self.Size / 2, Color( math.random( 200, 220 ), math.random( 100, 128 ), 0, self.Alpha ) )
	...
	render.DrawSprite( Pos2, self.Size / 2, self.Size / 2, Color( 0, math.random( 100, 128 ), math.random( 240, 255 ), self.Alpha ) )
end